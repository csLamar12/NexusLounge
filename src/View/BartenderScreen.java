...
//
//
//        List<OrderDetail> orderDetails = client.getOrderDetails(order);
//
//        List<String> drinks = new ArrayList<>();
//
//        for (OrderDetail orderDetail : orderDetails){
//            drinks.add(orderDetail.getDrinkId() + " x " + orderDetail.getQuantity());
//        }
//
...
//        BartenderScreen bartenderScreen = new BartenderScreen(new Client());
//
//        // Create orders with items
//        bartenderScreen.addOrder(new Order(1, 1, 1,new Date(),true));
//        bartenderScreen.addOrder(new Order(2, 2, 2,new Date(),true));
//        bartenderScreen.addOrder(new Order(3, 3, 3,new Date(),true));
//        bartenderScreen.addOrder(new Order(4, 4, 4,new Date(),true));
//
//        // Example timer to remove orders after a delay
//        Timer timer = new Timer(3000, e -> {
//            bartenderScreen.removeOrder(1);
//            bartenderScreen.removeOrder(2);
//        });
